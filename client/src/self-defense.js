...
import "./self-defense.css"
import ReactDOM from "react-dom";
import defense from "./images/self-defense.png"
import helpline from "./images/helpline.jpeg"
import women from "./images/women_safety.jpeg" 
class Heading extends React.Component{
        ...
        class Defense extends React.Component{
            ...
            return(
                <div width="30px" height="80px" id="defense">
                        <br/>
                        <img src={defense} class="self" width="200px" height="200px" />
            ...
            render(){
                return(
                    <div width="30px" height="80px" id="helpline">
                        <br/>
                        <img class="self" src={helpline} width="200px" height="200px" />
            ...
            render(){
                return(
                    <div width="30px" height="80px" id="safety" >
                        <br/>
                        <img  class="self" src={women} width="200px" height="200px" />
        ...
        class Selfdefense extends React.Component{
            render()
            {
                return(
                    <div>
